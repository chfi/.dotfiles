...
values."
  (setq-default
   ...
   '(
     ...
     latex
     (rcirc :variables
            rcirc-default-nick "chfi"
            rcirc-default-user-name "chfi"
            rcirc-default-full-name "Christian Fischer"
            )
     asm
     ess
     )
